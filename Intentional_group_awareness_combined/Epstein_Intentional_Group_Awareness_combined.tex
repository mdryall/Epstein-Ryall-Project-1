...
%XX\usepackage{booktabs}%for nice tables (see discuss at https://people.inf.ethz.ch/markusp/teaching/guides/guide-tables.pdf). For details see https://ctan.org/pkg/booktabs.
% A FANCY TABLE
...
% \caption{Caption}
% \end{table*}
%XX\usepackage{subcaption}%for tables and such
%XX\usepackage{lipsum} %for preventing breaks and such
%\usepackage{pgf,pgfarrows,pgfnodes,pgfshade}
%XX\usepackage{setspace} %Turn ON for editing
%\usepackage{verbatim}
...
%XX \doublespacing %This is a command from the SetSpace package
